...
export class Backend implements backendInterface {
    ...
    async addCaffeineEntry(arg0: string, arg1: bigint, arg2: bigint): Promise<CaffeineEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.addCaffeineEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addCaffeinePreset(arg0: string, arg1: bigint): Promise<CaffeinePreset> {
        if (this.processError) {
            try {
                const result = await this.actor.addCaffeinePreset(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCaffeineEntry(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCaffeineEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
